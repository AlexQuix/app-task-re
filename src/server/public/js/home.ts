...
// NOTEBOOK
abstract class NotebookForm{
    protected btnVisibleForm:HTMLButtonElement
    protected containerForm:HTMLDivElement;
    protected btnCloseForm:HTMLButtonElement;
    protected contForm:HTMLFormElement;
    protected btnCreateNewNotebook:HTMLButtonElement;
    constructor(){
        this.btnVisibleForm = document.querySelector<HTMLButtonElement>("#container-task > #btn-create-new-list-task > button");
        this.containerForm = document.querySelector<HTMLDivElement>("#container-task > #form-create-notebook");
        this.contForm = this.containerForm.querySelector<HTMLFormElement>("form");
        this.btnCloseForm = this.contForm.querySelector<HTMLButtonElement>("#btn-close");
...
class Notebook extends NotebookForm{
    ...
    addTaksWithinNotebook(task:IContentTask){
        let listTaskHTML = document.querySelector<HTMLDivElement>("#container-task > #cont-all-task-lists .cont-list-task > #cont-all-task");
...
// TASK
abstract class TaskOptionPriority{
        protected tagColorHTML:HTMLDivElement;
        protected btnPriorityTaskHTML: HTMLButtonElement;
        protected ULPriorityHTML: HTMLUListElement;
        private priorityOptionNotImportSVG:string;
        private priorityOptionsSVG: string;
        constructor(){
        ...
        tagColor(background:string):void{
            this.tagColorHTML.style.background = background;
        }
        findPriorityValue(){
            const {priority} = this.btnPriorityTaskHTML.dataset;

            let contLIAll = this.ULPriorityHTML.querySelectorAll<HTMLLIElement>("#cont-btns-config > #list-options-priority li");
        ...
        priorityOptionsEnable():void{
                ...
                this.btnPriorityTaskHTML.onclick = (e)=>{
                    ...
                    let contAllLI = this.ULPriorityHTML.querySelectorAll<HTMLLIElement>("#cont-btns-config > #list-options-priority li");
